...
%include "../real_mode_to_protected_mode/print_function.asm"
%include "../real_mode_to_protected_mode/disk_load.asm"
%include "../real_mode_to_protected_mode/gdt_32_pm.asm"
%include "../real_mode_to_protected_mode/protected_mode.asm"
%include "../real_mode_to_protected_mode/print_function_pm.asm"
